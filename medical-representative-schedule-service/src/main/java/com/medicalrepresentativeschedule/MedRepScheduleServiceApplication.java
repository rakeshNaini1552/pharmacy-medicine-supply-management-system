...
//                .paths(PathSelectors.ant("/*"))
                .apis(RequestHandlerSelectors.basePackage("com.pod2.medicalrepresentativeschedule.controller")).build()
                .apiInfo(apiInfo());
    }
	private ApiInfo apiInfo() {
        return new ApiInfo("USers Api", "Sample API for users", "1.0", "path/to/terms",
                new Contact("a", "http://www.google.com", "a@gmail.com"), "API License",
