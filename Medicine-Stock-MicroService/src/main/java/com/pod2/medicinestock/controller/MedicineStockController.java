package com.pod2.medicinestock.controller;
...
import com.pod2.medicinestock.exception.TokenValidationFailedException;
import com.pod2.medicinestock.feignclient.AuthenticationFeignClient;
import com.pod2.medicinestock.model.JwtResponse;
import com.pod2.medicinestock.model.MedicineStock;
import com.pod2.medicinestock.service.MedicineStockServiceImpl;
	...
	public ResponseEntity<?> getMedicineByTreatingAilment(@RequestHeader(name = "Authorization") String token,
		...
		try {
			...
			if (jwtResponse.isValid()) {
				...
				log.debug("MEDICINE BY TARGET ALIGNMENT:",medicineByTargetAilment);
